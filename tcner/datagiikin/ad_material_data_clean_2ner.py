...
@Read: 清洗并生成单纯地可以用来做NER标注的数据; 这个脚本只用来做NER数据标注文件的生成
"""
...
with open('./bigfiles/readdatafrommatterial.pick', 'rb') as f:
...
with open('./bigfiles/ad_material_data_clean_2ner_clean_with_interest_words.pick', 'wb') as f:

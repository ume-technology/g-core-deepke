...
from tcner.src.trainer import train
from tcner.src.options import Args
from tcner.src.model_utils import build_model
from tcner.src.dataset_utils import NERDataset
from tcner.src.evaluator import crf_evaluation, span_evaluation, mrc_evaluation
from tcner.src.functions_utils import set_seed, get_model_path_list, load_model_and_parallel, get_time_dif
from tcner.src.processor import NERProcessor, convert_examples_to_features
...
def training(opt):
    ...
    # todo 这里是Test伪标签数据的使用过程；这里的数据直接被当作Train data数据使用
